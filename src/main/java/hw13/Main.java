...
import hw13.Entity.*;
import hw13.Save.SaveAndLoad;
import hw13.io.ConsoleMain;
...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        String str = "C:\\Users\\shaxs\\IdeaProjects\\sevil\\src\\main\\java\\hw13\\myfile.bin";
        SaveAndLoad saveAndLoad = new SaveAndLoad(str);
        ...
        while (!quit) {
            ...
            switch (input) {
                ...
                case "9":
                    ...
                    break;
                case "10":
                    saveAndLoad.save(familyController);
                    break;
                case "11":
                    try {
                        saveAndLoad.load();
